...
import { LayoutDashboard, Users, BookOpen, FileText, BarChart3, School, Building2, Settings, Rocket, Menu, X, Home, Newspaper, Lightbulb, Contact, Send } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/mail-sender', label: 'Mail Sender', icon: Send },
