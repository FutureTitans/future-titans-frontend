...
export default function AboutUs() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="w-full bg-[#0A101D] px-4 sm:px-6 lg:px-8 py-20 lg:py-28 relative overflow-hidden">
        {/* Abstract background blobs */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-[#C8960C]/5 blur-[120px] rounded-full"></div>
          <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-blue-600/5 blur-[120px] rounded-full"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            <div className="bg-[#131A2A] border border-[#C8960C]/30 rounded-2xl p-8 flex flex-col items-center text-center shadow-[0_0_20px_rgba(200,150,12,0.1)] hover:-translate-y-2 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Think Differently</h3>
            ...
            <div className="bg-[#131A2A] border border-purple-500/30 rounded-2xl p-8 flex flex-col items-center text-center shadow-[0_0_20px_rgba(168,85,247,0.1)] hover:-translate-y-2 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Build Confidently</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <div className="bg-[#131A2A] border border-orange-500/30 rounded-2xl p-8 flex flex-col items-center text-center shadow-[0_0_20px_rgba(249,115,22,0.1)] hover:-translate-y-2 transition-all duration-300 group">
            ...
            <div className="bg-[#131A2A] border border-blue-500/30 rounded-2xl p-8 flex flex-col items-center text-center shadow-[0_0_20px_rgba(59,130,246,0.1)] hover:-translate-y-2 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Create Impact</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
      ...
      <section className="bg-[#0A101D] px-4 sm:px-6 lg:px-8 pb-16 lg:pb-24">
        <div className="max-w-7xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-[#0F172A] border border-gray-800">
            {/* Background Image */}
            <div className="absolute inset-0 z-0">
              <Image src="/images/yp/about-cta-bg.png" alt="CTA Background" fill className="object-cover object-left" />
            </div>
