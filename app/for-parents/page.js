        ...
        <div className="relative rounded-[2.5rem] overflow-hidden w-full bg-[#051934] min-h-[400px] flex items-center">
          ...
          <div className="relative z-10 p-10 lg:p-16 max-w-2xl w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="inline-flex items-center justify-center gap-2 border-2 border-white/30 text-white bg-transparent px-8 py-3.5 rounded-xl font-bold text-sm tracking-wide hover:bg-white/10 transition-all backdrop-blur-sm">
                Talk to Our Team
