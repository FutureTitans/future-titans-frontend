...
export const modules = {
  ...
  getLeaderboard: (limit = 10) => coreApi.get(`/modules/leaderboard?limit=${limit}`),
...
export const adminLeads = {
  ...
  bulkImport: (leads, importDescription) => api.post('/admin/leads/bulk-import', { leads, importDescription }),
