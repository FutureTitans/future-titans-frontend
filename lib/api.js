...
export const aiChat = {
  ...
  // Word balance & topup
  getWordBalance: () => chatApi.get('/chat/word-balance'),
  getTopupPackages: () => chatApi.get('/chat/topup/packages'),
  initiateTopup: (packageId) => chatApi.post('/chat/topup/initiate', { packageId }),
  verifyTopup: (data) => chatApi.post('/chat/topup/verify', data),
};
